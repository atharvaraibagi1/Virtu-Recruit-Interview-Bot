    ...
    if st.session_state.question_index < len(all_questions):
        ...
        for data in responses_data:
            with st.expander(f"Question {data['question_index'] + 1}"):
                ...
                score_class = (
                    "score-excellent" if data['score'] >= 80
                    else "score-good" if data['score'] >= 60
                    else "score-improve"
                )
                
                st.markdown(f"""
                    <div class="score-card {score_class}">
                        <h4>Score: {data['score']}/100</h4>
                        <p>{'🌟 Excellent!' if data['score'] >= 80 
                           else '👍 Good job!' if data['score'] >= 60 
                ...
                # Feedback section
                st.markdown("""
                    <div class="feedback-section" style="color: black;">
                        <h4 style="color: black;">💡 Detailed Feedback:</h4>
